 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_f')){
	function azrcrv_create_plugin_menu_f(){
		azrcrv_create_plugin_menu_table_f();
		azrcrv_populate_plugin_menu_table_f();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_f')){
	function azrcrv_populate_plugin_menu_table_f(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_f')){
	function azrcrv_create_plugin_menu_table_f(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
